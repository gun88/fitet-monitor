...
class Fitet_Monitor_Team_Image_Component_Test extends Fitet_Monitor_Test_Case {
	...
	public function main_test() {
		$expected = "<span class='fm-team-image'><img src='/fitet-monitor-no-logo.svg' alt='N/A'/></span>";
		$actual = Fitet_Monitor_Component_Wrapper::render_wrapper($this->component, []);
		$this->assertXmlStringEqualsXmlString($expected, $actual);

		$expected = "<span class='fm-team-image'><img src='http://portale.fitet.org/images/societa/1.jpg' alt='N/A' onError='this.onerror=null;this.src=\"/fitet-monitor-no-logo.svg\";'/></span>";
		$actual = Fitet_Monitor_Component_Wrapper::render_wrapper($this->component, ['clubCode' => '1']);
		$this->assertXmlStringEqualsXmlString($expected, $actual);

		$expected = "<span class='fm-team-image'><img src='/fitet-monitor-no-logo.svg' alt='Foo Bar'/></span>";
		$actual = Fitet_Monitor_Component_Wrapper::render_wrapper($this->component, ['teamName' => 'Foo Bar']);
		$this->assertXmlStringEqualsXmlString($expected, $actual);

		$expected = "<span class='fm-team-image'><img src='http://portale.fitet.org/images/societa/1.jpg' alt='Foo Bar' onError='this.onerror=null;this.src=\"/fitet-monitor-no-logo.svg\";'/></span>";
		$actual = Fitet_Monitor_Component_Wrapper::render_wrapper($this->component, ['clubCode' => '1', 'teamName' => 'Foo Bar']);
		$this->assertXmlStringEqualsXmlString($expected, $actual);

		$expected = "<a class='fm-team-image' href='/club.html'><img src='/fitet-monitor-no-logo.svg' alt='N/A'/></a>";
		$actual = Fitet_Monitor_Component_Wrapper::render_wrapper($this->component, ['teamPageUrl' => '/club.html']);
		$this->assertXmlStringEqualsXmlString($expected, $actual);

		$expected = "<a class='fm-team-image' href='/club.html'><img src='http://portale.fitet.org/images/societa/1.jpg' alt='N/A' onError='this.onerror=null;this.src=\"/fitet-monitor-no-logo.svg\";'/></a>";
		$actual = Fitet_Monitor_Component_Wrapper::render_wrapper($this->component, ['clubCode' => '1', 'teamPageUrl' => '/club.html']);
		$this->assertXmlStringEqualsXmlString($expected, $actual);

		$expected = "<a class='fm-team-image' href='/club.html'><img src='/fitet-monitor-no-logo.svg' alt='Foo Bar'/></a>";
		$actual = Fitet_Monitor_Component_Wrapper::render_wrapper($this->component, ['teamName' => 'Foo Bar', 'teamPageUrl' => '/club.html']);
		$this->assertXmlStringEqualsXmlString($expected, $actual);

		$expected = "<a class='fm-team-image' href='/club.html'><img src='http://portale.fitet.org/images/societa/1.jpg' alt='Foo Bar' onError='this.onerror=null;this.src=\"/fitet-monitor-no-logo.svg\";'/></a>";
