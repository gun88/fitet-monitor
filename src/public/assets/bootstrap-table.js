(function (global, factory) {
	...
	var CONFIGURABLE_LENGTH = DESCRIPTORS$7 && !fails$n(function () {
		return defineProperty$5(function () { /* empty */
  ...
  */
		...
		_createClass(BootstrapTable, [{
			...
			value: function initHeader() {
				...
				this.$container.off('click', '.th-inner').on('click', '.th-inner', function (e) {
					...
					if (_this2.options.detailView && !$this.parent().hasClass('bs-checkbox')) {
						if ($this.closest('.fm-bootstrap-table')[0] !== _this2.$container[0]) {
							return false;
						}
					}
				...
				var resizeEvent = Utils.getEventName('resize.fm-bootstrap-table', this.$el.attr('id'));
			...
			value: function initPagination() {
				...
				if (this.paginationParts.includes('pageSize')) {
					...
					var pageNumber = ["<div class=\"".concat(this.constants.classes.paginationDropdown, "\">\n        <button onclick='showDd(this)' class=\"").concat(this.constants.buttonsClass, " dropdown-toggle\" type=\"button\" ").concat(this.constants.dataToggle, "=\"dropdown\">\n        <span class=\"page-size\">\n        ").concat(allSelected ? opts.formatAllRows() : opts.pageSize, "\n        </span>\n        ").concat(this.constants.html.dropdownCaret, "\n        </button>\n        ").concat(this.constants.html.pageDropdown[0])];
			...
			value: function toggleFullscreen() {
				this.$el.closest('.fm-bootstrap-table').toggleClass('fullscreen');
				this.resetView();
			}
		}, {
			key: "toggleView",
	...
	$__default["default"](function () {
		$__default["default"]('[data-toggle="fm-table"]').bootstrapTable();
	});
...
function showDd(btn) {
	btn = jQuery(btn);
	let toggle = btn.data('bs-toggle');
	let closest = btn.closest('.' + toggle);
	jQuery(closest).find('.dropdown-menu').show();
}
