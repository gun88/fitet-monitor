...
jQuery(function ($) {
	...
	dt = {
		init: function (element, options) {
			...
			this.$element = $(element);
			this.$headerDiv = $("<div id='dynatable-header-" + this.element.id + "' class='dynatable-header'></div>");
			this.$element.before(this.$headerDiv);
			this.$footerRecordsDiv = $("<div id='dynatable-records-" + this.element.id + "' class='dynatable-records'></div>");
			this.$footerPaginationDiv = $("<div id='dynatable-pagination-" + this.element.id + "' class='dynatable-pagination'></div>");
			this.$footerDiv = $("<div id='dynatable-footer-" + this.element.id + "' class='dynatable-footer'></div>");
			this.$footerDiv.append(this.$footerRecordsDiv);
			this.$footerDiv.append(this.$footerPaginationDiv);
			this.$element.after(this.$footerDiv);
			this.$element.wrap("<div id='dynatable-wrapper-" + this.element.id + "' class='dynatable-wrapper'></div>")
	...
	function RecordsCount(obj, settings) {
		...
		this.attach = function () {
			if (settings.inputs.recordCountTarget) {
				$(settings.inputs.recordCountTarget).append(this.create());
			} else if (obj.$element[settings.inputs.recordCountPlacement] === 'before') {
				obj.$headerDiv.append(this.create());
			} else {
				obj.$footerRecordsDiv.append(this.create());
			}
	...
	function InputsSearch(obj, settings) {
		...
		this.create = function () {
			var $search = $('<input />', {
					...
					'placeholder': settings.inputs.searchPlaceholderText,
		...
		this.attach = function () {
			if (settings.inputs.searchTarget) {
				$(settings.inputs.searchTarget).append(this.create());
			} else if (obj.$element[settings.inputs.searchPlacement] === 'after') {
				obj.$footerPaginationDiv.append(this.create());
			} else {
				obj.$headerDiv.append(this.create());
			}
		};
	...
	function PaginationPerPage(obj, settings) {
		...
		this.attach = function () {
			if (settings.inputs.perPageTarget) {
				$(settings.inputs.perPageTarget).append(this.create());
			} else if (obj.$element[settings.inputs.perPagePlacement] === 'before') {
				obj.$headerDiv.append(this.create());
			} else {
				obj.$footerRecordsDiv.append(this.create());
			}
	...
	function PaginationLinks(obj, settings) {
		...
		this.attach = function () {
			...
			if (settings.inputs.paginationLinkTarget) {
				$(settings.inputs.paginationLinkTarget).append(this.create());
			} else if (obj.$element[settings.inputs.paginationLinkPlacement] === 'before') {
				obj.$headerDiv.append(this.create());
			} else {
				obj.$footerPaginationDiv.append(this.create());
			}
